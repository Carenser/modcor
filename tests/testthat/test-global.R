...
test_perim = LoadPerimetre(dossiers = paste0(getwd(),'/data-raw/201801'))
...
test_cdc_nebef = LoadCdC(fichiers = list.files(path = paste0(getwd(),'/data-raw/201801'), pattern = 'NEBEF_CRS', full.names = TRUE))
