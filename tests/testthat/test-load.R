...
dir = 'C:/Users/D33071/Documents/R/MyPackages/MODCOR/data-raw/'

logfilename <- paste0('C:/Users/D33071/Documents/R/MyPackages/MODCOR/data-raw/log/', format(Sys.time(),"_%Y%m%d_%H%M%S.txt"))

logprint<-function(logtext, logfilename1=""){
  if(logfilename1=="") logfilename1<-logfilename
  write.table(logtext,logfilename1,append=TRUE,row.names=FALSE,col.names=FALSE,quote=FALSE)
}
